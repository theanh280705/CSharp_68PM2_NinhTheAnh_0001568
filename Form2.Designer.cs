...
namespace WinFormsApp1
{
    public partial class FormQuanLySinhVien : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            ToolStripMenuItem menuDangXuat = new ToolStripMenuItem("Đăng xuất");
            menuDangXuat.ForeColor = Color.Red;
            ...
            // 3. Panel Phải - Tìm kiếm & Danh sách
            panelRight = new Panel
            {
                Location = new Point(360, 40),
                Size = new Size(710, 650),
            ...
            // DataGridView hiển thị dữ liệu sinh viên
            dgvSinhVien = new DataGridView
            {
                Location = new Point(10, 80),
                Size = new Size(690, 470),
            ...
            // 4. Thanh phân trang dưới cùng bên phải
            panelPhanTrang = new Panel { Location = new Point(10, 560), Size = new Size(690, 50) };
            ...
            lblPhanTrang = new Label { Text = "Trang 1/1  |  3 bản ghi", Location = new Point(280, 15), AutoSize = true };
            btnNext = new Button { Text = ">", Location = new Point(555, 10), Size = new Size(60, 30) };
            btnLast = new Button { Text = ">>", Location = new Point(620, 10), Size = new Size(60, 30) };
        ...
        // Tạo dữ liệu giả lập đổ vào bảng giống trong hình mẫu
